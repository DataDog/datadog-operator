...
// DatadogDashboardSpec defines the desired state of DatadogDashboard v1alpha2
...
type DatadogDashboardSpec struct {
	...
	// Widgets is a list of dashboard widgets defined in native YAML
	// +optional
...
// DashboardWidget represents a single dashboard widget
// +k8s:openapi-gen=true
type DashboardWidget struct {
	// ID is the widget ID (optional for creation)
	// +optional
	ID *int64 `json:"id,omitempty"`

	// Definition contains the widget configuration
	// +kubebuilder:validation:Required
	Definition runtime.RawExtension `json:"definition"`

	// Layout defines the widget position and size
	// +optional
	Layout *WidgetLayout `json:"layout,omitempty"`
}

// WidgetLayout defines widget positioning
// +k8s:openapi-gen=true

...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatadogPodAutoscalerFallbackApplyPolicy) DeepCopyInto(out *DatadogPodAutoscalerFallbackApplyPolicy) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatadogPodAutoscalerFallbackApplyPolicy.
func (in *DatadogPodAutoscalerFallbackApplyPolicy) DeepCopy() *DatadogPodAutoscalerFallbackApplyPolicy {
	if in == nil {
		return nil
	}
	out := new(DatadogPodAutoscalerFallbackApplyPolicy)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DatadogPodAutoscalerSpec) DeepCopyInto(out *DatadogPodAutoscalerSpec) {
	*out = *in
	...
	if in.FallbackObjectives != nil {
		in, out := &in.FallbackObjectives, &out.FallbackObjectives
		*out = make([]common.DatadogPodAutoscalerObjective, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}

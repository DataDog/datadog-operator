...
type DatadogPodAutoscalerProfileStatus struct {
	...
	// ObservedGeneration is the generation of the DatadogPodAutoscalerProfile that was last processed by the controller.
...
// +kubebuilder:resource:shortName=dpap,scope=Cluster
...
// DatadogPodAutoscalerClusterProfile is the Schema for the datadogpodautoscalerprofiles API
...
// +kubebuilder:object:root=true
// DatadogPodAutoscalerClusterProfileList contains a list of DatadogPodAutoscalerProfiles

...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/DataDog/datadog-operator/api/datadoghq/v2alpha1.HostProfilerFeatureConfig":           schema_datadog_operator_api_datadoghq_v2alpha1_HostProfilerFeatureConfig(ref),
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"hostProfiler": {
						SchemaProps: spec.SchemaProps{
							Description: "HostProfiler configuration.",
							Ref:         ref("github.com/DataDog/datadog-operator/api/datadoghq/v2alpha1.HostProfilerFeatureConfig"),
						},
					},
					"otelCollector": {
						SchemaProps: spec.SchemaProps{
...
func schema_datadog_operator_api_datadoghq_v2alpha1_HostProfilerFeatureConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "HostProfilerFeatureConfig contains the Host Profiler configuration.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"enabled": {
						SchemaProps: spec.SchemaProps{
							Description: "Enables the Host Profiler. Default: false",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},

				...
				Properties: map[string]spec.Schema{
					...
					"autodiscovery": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/DataDog/datadog-operator/api/datadoghq/v2alpha1.AutodiscoveryConfig"),
						},
					},
					"eventCollection": {
						SchemaProps: spec.SchemaProps{

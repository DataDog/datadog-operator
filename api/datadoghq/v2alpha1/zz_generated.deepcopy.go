...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CoreAgent) DeepCopyInto(out *CoreAgent) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CoreAgent.
func (in *CoreAgent) DeepCopy() *CoreAgent {
	if in == nil {
		return nil
	}
	out := new(CoreAgent)
...
func (in *GlobalConfig) DeepCopyInto(out *GlobalConfig) {
	*out = *in
	...
	if in.CoreAgent != nil {
		in, out := &in.CoreAgent, &out.CoreAgent
		*out = new(CoreAgent)
		(*in).DeepCopyInto(*out)
	}
}

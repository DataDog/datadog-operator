...
func (in *APMFeatureConfig) DeepCopyInto(out *APMFeatureConfig) {
	*out = *in
	...
	if in.ErrorTracking != nil {
		in, out := &in.ErrorTracking, &out.ErrorTracking
		*out = new(ErrorTracking)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ErrorTracking) DeepCopyInto(out *ErrorTracking) {
	*out = *in
	if in.Mode != nil {
		in, out := &in.Mode, &out.Mode
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ErrorTracking.
func (in *ErrorTracking) DeepCopy() *ErrorTracking {
	if in == nil {
		return nil
	}
	out := new(ErrorTracking)

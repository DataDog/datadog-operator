...
func (in *DatadogFeatures) DeepCopyInto(out *DatadogFeatures) {
	*out = *in
	...
	if in.WorkloadCapturer != nil {
		in, out := &in.WorkloadCapturer, &out.WorkloadCapturer
		*out = new(WorkloadCapturerFeatureConfig)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkloadCapturerFeatureConfig) DeepCopyInto(out *WorkloadCapturerFeatureConfig) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
	...
	if in.DogstatsdPort != nil {
		in, out := &in.DogstatsdPort, &out.DogstatsdPort
		*out = new(int32)
		**out = **in
	}
	if in.FlushIntervalSeconds != nil {
		in, out := &in.FlushIntervalSeconds, &out.FlushIntervalSeconds
		*out = new(int32)
		**out = **in
	}
	if in.MaxContexts != nil {
		in, out := &in.MaxContexts, &out.MaxContexts
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadCapturerFeatureConfig.
func (in *WorkloadCapturerFeatureConfig) DeepCopy() *WorkloadCapturerFeatureConfig {
	if in == nil {
		return nil
	}
	out := new(WorkloadCapturerFeatureConfig)

...
func (in *DatadogFeatures) DeepCopyInto(out *DatadogFeatures) {
	*out = *in
	...
	if in.FlightRecorder != nil {
		...
		*out = new(FlightRecorderFeatureConfig)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlightRecorderFeatureConfig) DeepCopyInto(out *FlightRecorderFeatureConfig) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FlightRecorderFeatureConfig.
func (in *FlightRecorderFeatureConfig) DeepCopy() *FlightRecorderFeatureConfig {
	if in == nil {
		return nil
	}
	out := new(FlightRecorderFeatureConfig)

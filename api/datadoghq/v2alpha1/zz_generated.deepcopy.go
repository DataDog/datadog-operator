...
func (in *DatadogFeatures) DeepCopyInto(out *DatadogFeatures) {
	*out = *in
	if in.OTelAgent != nil {
		in, out := &in.OTelAgent, &out.OTelAgent
		*out = new(OTelAgentFeatureConfig)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OTelAgentFeatureConfig) DeepCopyInto(out *OTelAgentFeatureConfig) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OTelAgentFeatureConfig.
func (in *OTelAgentFeatureConfig) DeepCopy() *OTelAgentFeatureConfig {
	if in == nil {
		return nil
	}
	out := new(OTelAgentFeatureConfig)

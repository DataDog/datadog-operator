...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkCRDsConfig) DeepCopyInto(out *NetworkCRDsConfig) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkCRDsConfig.
func (in *NetworkCRDsConfig) DeepCopy() *NetworkCRDsConfig {
	if in == nil {
		return nil
	}
	out := new(NetworkCRDsConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OrchestratorExplorerFeatureConfig) DeepCopyInto(out *OrchestratorExplorerFeatureConfig) {
	*out = *in
	...
	if in.NetworkCRDs != nil {
		in, out := &in.NetworkCRDs, &out.NetworkCRDs
		*out = new(NetworkCRDsConfig)
		(*in).DeepCopyInto(*out)
	}
}

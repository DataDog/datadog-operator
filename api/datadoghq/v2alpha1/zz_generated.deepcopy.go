...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatadogPodAutoscalerActuation) DeepCopyInto(out *DatadogPodAutoscalerActuation) {
	*out = *in
	if in.Update != nil {
...
func (in *DatadogPodAutoscalerActuation) DeepCopy() *DatadogPodAutoscalerActuation {
	if in == nil {
		return nil
	}
	out := new(DatadogPodAutoscalerActuation)
	in.DeepCopyInto(out)
	return out
}

...
func (in *DatadogFeatures) DeepCopyInto(out *DatadogFeatures) {
	*out = *in
	...
	if in.GPUMonitoring != nil {
		in, out := &in.GPUMonitoring, &out.GPUMonitoring
		*out = new(GPUMonitoringFeatureConfig)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GPUMonitoringFeatureConfig) DeepCopyInto(out *GPUMonitoringFeatureConfig) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GPUMonitoringFeatureConfig.
func (in *GPUMonitoringFeatureConfig) DeepCopy() *GPUMonitoringFeatureConfig {
	if in == nil {
		return nil
	}
	out := new(GPUMonitoringFeatureConfig)

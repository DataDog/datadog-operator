...
func (in *DatadogPodAutoscalerObjective) DeepCopyInto(out *DatadogPodAutoscalerObjective) {
	*out = *in
	...
	if in.CustomQueryObjective != nil {
		in, out := &in.CustomQueryObjective, &out.CustomQueryObjective
		*out = new(DatadogPodAutoscalerCustomQueryObjective)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatadogPodAutoscalerQueryFormula) DeepCopyInto(out *DatadogPodAutoscalerQueryFormula) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatadogPodAutoscalerQueryFormula.
func (in *DatadogPodAutoscalerQueryFormula) DeepCopy() *DatadogPodAutoscalerQueryFormula {
	if in == nil {
		return nil
	}
	out := new(DatadogPodAutoscalerQueryFormula)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DatadogPodAutoscalerTimeseriesFormulaRequest) DeepCopyInto(out *DatadogPodAutoscalerTimeseriesFormulaRequest) {
	*out = *in
	if in.Formulas != nil {
		...
		*out = make([]DatadogPodAutoscalerQueryFormula, len(*in))
		copy(*out, *in)
	}
	if in.Queries != nil {

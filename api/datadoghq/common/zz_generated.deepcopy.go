...
func (in *DatadogPodAutoscalerHorizontalStatus) DeepCopyInto(out *DatadogPodAutoscalerHorizontalStatus) {
	*out = *in
	...
	if in.LastRecommendations != nil {
		...
		*out = make([]DatadogPodAutoscalerRecommendation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatadogPodAutoscalerRecommendation) DeepCopyInto(out *DatadogPodAutoscalerRecommendation) {
	*out = *in
	in.Time.DeepCopyInto(&out.Time)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatadogPodAutoscalerRecommendation.
func (in *DatadogPodAutoscalerRecommendation) DeepCopy() *DatadogPodAutoscalerRecommendation {
	if in == nil {
		return nil
	}
	out := new(DatadogPodAutoscalerRecommendation)
	in.DeepCopyInto(out)
	return out
}

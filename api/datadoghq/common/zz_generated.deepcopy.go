...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatadogPodAutoscalerRecommendationOptions) DeepCopyInto(out *DatadogPodAutoscalerRecommendationOptions) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatadogPodAutoscalerRecommendationOptions.
func (in *DatadogPodAutoscalerRecommendationOptions) DeepCopy() *DatadogPodAutoscalerRecommendationOptions {
	if in == nil {
		return nil
	}
	out := new(DatadogPodAutoscalerRecommendationOptions)
	in.DeepCopyInto(out)
	return out
}

...
func schema_DataDog_datadog_operator_api_v1alpha1_APMSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/DataDog/datadog-operator/api/v1alpha1.APMUnixDomainSocketSpec", "k8s.io/api/core/v1.EnvVar", "k8s.io/api/core/v1.ResourceRequirements", "k8s.io/api/core/v1.VolumeMount"},
	}
}
...
func schema_DataDog_datadog_operator_api_v1alpha1_SecuritySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/DataDog/datadog-operator/api/v1alpha1.ComplianceSpec", "github.com/DataDog/datadog-operator/api/v1alpha1.RuntimeSecuritySpec", "k8s.io/api/core/v1.EnvVar", "k8s.io/api/core/v1.ResourceRequirements", "k8s.io/api/core/v1.VolumeMount"},
	}
}

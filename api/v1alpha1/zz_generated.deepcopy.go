...
func (in *DatadogAgentSpec) DeepCopyInto(out *DatadogAgentSpec) {
	*out = *in
	...
	if in.DatadogFeatures != nil {
		in, out := &in.DatadogFeatures, &out.DatadogFeatures
...
func (in *OrchestratorExplorerConfig) DeepCopyInto(out *OrchestratorExplorerConfig) {
	*out = *in
	...
	if in.ContainerScrubbingEnabled != nil {
		in, out := &in.ContainerScrubbingEnabled, &out.ContainerScrubbingEnabled
		*out = new(bool)
		**out = **in
	}

...
func (in *APMFeatureSpec) DeepCopyInto(out *APMFeatureSpec) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new APMFeatureSpec.
func (in *APMFeatureSpec) DeepCopy() *APMFeatureSpec {
	if in == nil {
		return nil
	}
	out := new(APMFeatureSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *APMSpec) DeepCopyInto(out *APMSpec) {
	*out = *in
	if in.FeatureSpec != nil {
		in, out := &in.FeatureSpec, &out.FeatureSpec
		*out = new(APMFeatureSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.ContainerConfig != nil {
		in, out := &in.ContainerConfig, &out.ContainerConfig
		*out = new(DatadogAgentGenericContainerConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *ClusterAgentConfig) DeepCopyInto(out *ClusterAgentConfig) {
	*out = *in
	...
	if in.Features != nil {
		...
		*out = new(FeaturesConfigClusterAgent)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatadogAgentGenericContainerConfig) DeepCopyInto(out *DatadogAgentGenericContainerConfig) {
	*out = *in
	if in.Env != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatadogAgentGenericContainerConfig.
func (in *DatadogAgentGenericContainerConfig) DeepCopy() *DatadogAgentGenericContainerConfig {
	if in == nil {
		return nil
	}
	out := new(DatadogAgentGenericContainerConfig)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FeaturesConfigClusterAgent) DeepCopyInto(out *FeaturesConfigClusterAgent) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FeaturesConfigClusterAgent.
func (in *FeaturesConfigClusterAgent) DeepCopy() *FeaturesConfigClusterAgent {
	if in == nil {
		return nil
	}
	out := new(FeaturesConfigClusterAgent)

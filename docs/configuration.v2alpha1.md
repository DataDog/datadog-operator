...
| features.kubeStateMetricsCore.collectConfigMaps | CollectConfigMaps enables collection of metrics on ConfigMaps. When false, the `configmaps` collector and the RBAC permission to list/watch ConfigMaps are omitted. Default: true |
...
| features.kubeStateMetricsCore.collectSecretMetrics | CollectSecretMetrics enables collection of metrics on Secrets. When false, the `secrets` collector and the RBAC permission to list/watch Secrets are omitted. Default: true |

...
| features.otelCollectorGateway.enabled | Enables the OTel Collector Gateway. Default: false |
| features.otelCollectorGateway.ports | Contains the ports that the OTel Collector is listening on. Defaults: otel-grpc:4317 / otel-http:4318. |

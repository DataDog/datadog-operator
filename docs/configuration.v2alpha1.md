...
| [key].celWorkloadExclude.products | Products defines a list of products to exclude from collection. |
| [key].celWorkloadExclude.rules.containers | Containers exclude rule |
| [key].celWorkloadExclude.rules.kube_endpoints | KubeEndpoints exclude rule |
| [key].celWorkloadExclude.rules.kube_services | KubeServices exclude rule |
| [key].celWorkloadExclude.rules.pods | Pods exclude rule |
| [key].celWorkloadExclude.rules.processes | Processes exclude rule |

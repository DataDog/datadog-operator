...
| global.processChecksInCoreAgentEnabled | Configure whether the process Agent or core Agent collects process and/or container information (Linux only). (Requires Agent 7.57.0+) Default: 'false' |

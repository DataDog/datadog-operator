...
| global.kubelet.podResourcesSocket | PodResourcesSocketDir is the path to the folder where the pod resources socket is, to be used to read pod resource assignments Default: `/var/lib/kubelet/pod-resources/` |

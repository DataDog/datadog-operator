...
| features.kubeStateMetricsCore.useApiServerCache | UseApiServerCache enables the KSM Core check to use the Kubernetes API server cache for list and watch operations. Reduces load on etcd for large clusters. Default: false |

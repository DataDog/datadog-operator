...
| clusterAgent.config.admissionController.cwsInstrumentation.enabled | Enable the CWS Instrumentation admission controller endpoint |
| clusterAgent.config.admissionController.cwsInstrumentation.mode | Mode defines how the CWS Instrumentation endpoint should behave. It can be "init_container" or "remote_copy". |

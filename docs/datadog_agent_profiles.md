...
| `gke-autopilot` | [Autopilot-mode node pools](https://docs.cloud.google.com/kubernetes-engine/docs/concepts/about-autopilot-mode-standard-clusters) in a Standard cluster | Expected to work through the same mechanism, but not explicitly tested with DAPs |

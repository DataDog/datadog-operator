...
$ROOT/bin/yq w -i $OLM_FILE "spec.customresourcedefinitions.owned(name==datadogagents.datadoghq.com).displayName" "Datadog Agent"
$ROOT/bin/yq w -i $OLM_FILE "spec.customresourcedefinitions.owned(name==datadogmetrics.datadoghq.com).displayName" "Datadog Metric"

...
func Test_removeAnnotationLabel(t *testing.T) {
	tests := []struct {
		name         string
		...
		{
			name:         "remove val",
			vals:         map[string]string{"foo": "bar", "fizz": "buzz"},
			valToRemove:  "foo",
			expectedVals: map[string]string{"fizz": "buzz"},
		},
		{
			name:         "remove val that's not present",
			vals:         map[string]string{"foo": "bar", "fizz": "buzz"},
			valToRemove:  "bar",
			expectedVals: map[string]string{"foo": "bar", "fizz": "buzz"},
		},
		{
			name:         "remove empty val",
			vals:         map[string]string{"foo": "bar", "fizz": "buzz"},
			valToRemove:  "",
			expectedVals: map[string]string{"foo": "bar", "fizz": "buzz"},
		},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := removeAnnotationLabel(tt.vals, tt.valToRemove)
			assert.Equal(t, tt.expectedVals, got)
		})
	}
}

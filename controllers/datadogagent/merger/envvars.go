...
type EnvVarManager interface {
	...
	AddEnvVar(newEnvVar *corev1.EnvVar, mergeFunc EnvVarMergeFunction)
	...
	// The way the EnvVar is merge with an existing EnvVar can be tune thank to the EnvVarMergeFunction parameter.
	AddEnvVarToContainerWithMergeFunc(containerName string, newEnvVar *corev1.EnvVar, mergeFunc EnvVarMergeFunction) error
}
...
func (impl *envVarManagerImpl) AddEnvVar(newEnvVar *corev1.EnvVar, mergeFunc EnvVarMergeFunction) {
...
func (impl *envVarManagerImpl) AddEnvVarToContainer(containerName string, newEnvVar *corev1.EnvVar) {
	_ = impl.AddEnvVarToContainerWithMergeFunc(containerName, newEnvVar, DefaultEnvVarMergeFunction)
}

func (impl *envVarManagerImpl) AddEnvVarToContainerWithMergeFunc(containerName string, newEnvVar *corev1.EnvVar, mergeFunc EnvVarMergeFunction) error {
	for id := range impl.podTmpl.Spec.Containers {

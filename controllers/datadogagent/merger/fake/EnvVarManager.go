...
type EnvVarManager struct {
	EnvVarsByC map[common.ContainerName][]*v1.EnvVar
...
func (_m *EnvVarManager) AddEnvVarToContainer(containerName common.ContainerName, newEnvVar *v1.EnvVar) {
	_m.t.Logf("AddEnvVar %s: %#v", newEnvVar.Name, newEnvVar.Value)
...
func (_m *EnvVarManager) AddEnvVarToContainerWithMergeFunc(containerName common.ContainerName, newEnvVar *v1.EnvVar, mergeFunc merger.EnvVarMergeFunction) error {
	found := false
	idFound := 0
...
func NewFakeEnvVarManager(t testing.TB) *EnvVarManager {
	return &EnvVarManager{
		EnvVarsByC: make(map[common.ContainerName][]*v1.EnvVar),
		t:          t,
	}
}

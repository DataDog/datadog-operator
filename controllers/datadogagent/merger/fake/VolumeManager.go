...
type VolumeManager struct {
	VolumeByC      map[commonv1.AgentContainerName][]*v1.Volume
...
func (_m *VolumeManager) volumeMerge(containerName commonv1.AgentContainerName, volume *v1.Volume, volumeMergeFunc merger.VolumeMergeFunction) error {
	found := false
	idFound := 0
...
func NewFakeVolumeManager(t testing.TB) *VolumeManager {
	return &VolumeManager{
		VolumeByC:      make(map[commonv1.AgentContainerName][]*v1.Volume),

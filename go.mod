...
replace github.com/DataDog/helm-charts/tools/yaml-mapper => ../helm-charts/tools/yaml-mapper
...
require (
	...
	github.com/DataDog/helm-charts/tools/yaml-mapper v0.0.0-20250930155230-7f64091e4205

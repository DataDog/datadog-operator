...
require (
	...
	github.com/DataDog/datadog-agent/pkg/proto v0.51.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/backoff v0.51.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/grpc v0.51.0-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/util/http v0.51.0-rc.1 // indirect

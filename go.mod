...
replace (
	...
	github.com/DataDog/datadog-agent/pkg/config/model => ../datadog-agent/pkg/config/model
	github.com/DataDog/datadog-agent/pkg/config/remote => ../datadog-agent/pkg/config/remote
	github.com/DataDog/datadog-agent/pkg/obfuscate => ../datadog-agent/pkg/obfuscate
	github.com/DataDog/datadog-agent/pkg/proto => ../datadog-agent/pkg/proto
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state => ../datadog-agent/pkg/remoteconfig/state
	github.com/DataDog/datadog-agent/pkg/telemetry => ../datadog-agent/pkg/telemetry
	github.com/DataDog/datadog-agent/pkg/util/backoff => ../datadog-agent/pkg/util/backoff
	github.com/DataDog/datadog-agent/pkg/util/fxutil => ../datadog-agent/pkg/util/fxutil
	github.com/DataDog/datadog-agent/pkg/util/grpc => ../datadog-agent/pkg/util/grpc
	github.com/DataDog/datadog-agent/pkg/util/http => ../datadog-agent/pkg/util/http
	github.com/DataDog/datadog-agent/pkg/util/log => ../datadog-agent/pkg/util/log
	github.com/DataDog/datadog-agent/pkg/util/scrubber => ../datadog-agent/pkg/util/scrubber
	github.com/DataDog/datadog-agent/pkg/version => ../datadog-agent/pkg/version
)
...
require (
	...
	github.com/openshift/api v0.0.0-20231211194045-2679f634dcf6
)
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/telemetry v0.50.0-rc.4 // indirect
	github.com/DataDog/datadog-agent/pkg/util/backoff v0.50.0-rc.4 // indirect
	github.com/DataDog/datadog-agent/pkg/util/fxutil v0.50.0-rc.4 // indirect
	github.com/DataDog/datadog-agent/pkg/util/grpc v0.50.0-rc.4 // indirect
	github.com/DataDog/datadog-agent/pkg/util/http v0.50.0-rc.4 // indirect

...
const (
	...
	UnprivilegedMultiProcessAgentContainerName AgentContainerName = "non-privileged-multi-process-agent"
	...
	// ClusterAgentContainerName is the name of the Agent Data Plane container

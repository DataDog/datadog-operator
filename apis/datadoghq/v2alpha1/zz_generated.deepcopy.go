...
func (in *DatadogFeatures) DeepCopyInto(out *DatadogFeatures) {
	*out = *in
	...
	if in.Profiling != nil {
		...
		*out = new(ProfilingFeatureConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.CSPM != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProfilingFeatureConfig) DeepCopyInto(out *ProfilingFeatureConfig) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProfilingFeatureConfig.
func (in *ProfilingFeatureConfig) DeepCopy() *ProfilingFeatureConfig {
	if in == nil {
		return nil
	}
	out := new(ProfilingFeatureConfig)

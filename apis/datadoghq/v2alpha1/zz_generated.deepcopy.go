...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EventCollectionConfig) DeepCopyInto(out *EventCollectionConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EventCollectionConfig.
func (in *EventCollectionConfig) DeepCopy() *EventCollectionConfig {
	if in == nil {
		return nil
	}
	out := new(EventCollectionConfig)
...
func (in *NPMFeatureConfig) DeepCopyInto(out *NPMFeatureConfig) {
	*out = *in
	...
	if in.UseConntrack != nil {
		in, out := &in.UseConntrack, &out.UseConntrack
		*out = new(bool)
		**out = **in
	}

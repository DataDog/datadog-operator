...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerProcessModel) DeepCopyInto(out *ContainerProcessModel) {
	*out = *in
	if in.UseMultiProcessContainer != nil {
		in, out := &in.UseMultiProcessContainer, &out.UseMultiProcessContainer
		*out = new(bool)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContainerProcessModel.
func (in *ContainerProcessModel) DeepCopy() *ContainerProcessModel {
	if in == nil {
		return nil
	}
	out := new(ContainerProcessModel)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DatadogAgentComponentOverride) DeepCopyInto(out *DatadogAgentComponentOverride) {
	*out = *in
	...
	if in.SecurityContextConstraints != nil {
		in, out := &in.SecurityContextConstraints, &out.SecurityContextConstraints
...
func (in *GlobalConfig) DeepCopyInto(out *GlobalConfig) {
	*out = *in
	...
	if in.ContainerProcessModel != nil {
		in, out := &in.ContainerProcessModel, &out.ContainerProcessModel
		*out = new(ContainerProcessModel)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *SecurityContextConstraintsConfig) DeepCopyInto(out *SecurityContextConstraintsConfig) {
	*out = *in
	...
	if in.CustomConfiguration != nil {
		...
		*out = new(securityv1.SecurityContextConstraints)
		(*in).DeepCopyInto(*out)
	}
}

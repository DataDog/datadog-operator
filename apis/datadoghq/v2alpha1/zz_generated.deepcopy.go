...
func (in *AdmissionControllerFeatureConfig) DeepCopyInto(out *AdmissionControllerFeatureConfig) {
	*out = *in
	...
	if in.CWSInstrumentation != nil {
		...
		*out = new(CWSInstrumentationFeatureConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CWSInstrumentationFeatureConfig) DeepCopyInto(out *CWSInstrumentationFeatureConfig) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CWSInstrumentationFeatureConfig.
func (in *CWSInstrumentationFeatureConfig) DeepCopy() *CWSInstrumentationFeatureConfig {
	if in == nil {
		return nil
	}
	out := new(CWSInstrumentationFeatureConfig)

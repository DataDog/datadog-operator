...
func (in *DatadogAgentStatus) DeepCopyInto(out *DatadogAgentStatus) {
	*out = *in
	...
	if in.ClusterAgent != nil {
		...
		*out = new(commonv1.DeploymentStatus)
		(*in).DeepCopyInto(*out)
	}
...
func (in *DatadogFeatures) DeepCopyInto(out *DatadogFeatures) {
	*out = *in
	...
	if in.SecretsBackend != nil {
		...
		*out = new(SecretsBackendFeatureConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecretsBackendFeatureConfig) DeepCopyInto(out *SecretsBackendFeatureConfig) {
	*out = *in
	if in.Command != nil {
		in, out := &in.Command, &out.Command
		*out = new(string)
	...
	if in.Roles != nil {
		...
		*out = make([]*SecretsBackendRolesConfig, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(SecretsBackendRolesConfig)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecretsBackendFeatureConfig.
func (in *SecretsBackendFeatureConfig) DeepCopy() *SecretsBackendFeatureConfig {
	if in == nil {
		return nil
	}
	out := new(SecretsBackendFeatureConfig)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecretsBackendRolesConfig) DeepCopyInto(out *SecretsBackendRolesConfig) {
	*out = *in
	if in.Namespace != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecretsBackendRolesConfig.
func (in *SecretsBackendRolesConfig) DeepCopy() *SecretsBackendRolesConfig {
	if in == nil {
		return nil
	}
	out := new(SecretsBackendRolesConfig)

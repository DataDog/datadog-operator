...
func (in *LiveContainerCollectionFeatureConfig) DeepCopyInto(out *LiveContainerCollectionFeatureConfig) {
	*out = *in
	...
	if in.RunInCoreAgent != nil {
		in, out := &in.RunInCoreAgent, &out.RunInCoreAgent
		*out = new(ProcessesRunInCoreAgent)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProcessesRunInCoreAgent) DeepCopyInto(out *ProcessesRunInCoreAgent) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProcessesRunInCoreAgent.
func (in *ProcessesRunInCoreAgent) DeepCopy() *ProcessesRunInCoreAgent {
	if in == nil {
		return nil
	}
	out := new(ProcessesRunInCoreAgent)

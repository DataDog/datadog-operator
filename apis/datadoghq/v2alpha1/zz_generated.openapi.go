				...
				Properties: map[string]spec.Schema{
					...
					"update": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("./apis/datadoghq/v2alpha1.UpdateFeatureConfig"),
						},
					},
					"eventCollection": {
						SchemaProps: spec.SchemaProps{

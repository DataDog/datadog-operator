				...
				Properties: map[string]spec.Schema{
					...
					"autoscaling": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/DataDog/datadog-operator/apis/datadoghq/v2alpha1.AutoscalingFeatureConfig"),
						},
					},
					"clusterChecks": {
						SchemaProps: spec.SchemaProps{
...
func schema_datadog_operator_apis_datadoghq_v2alpha1_EventCollectionFeatureConfig(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/DataDog/datadog-operator/apis/datadoghq/v2alpha1.EventTypes"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/DataDog/datadog-operator/apis/datadoghq/v2alpha1.EventTypes"},
	}
}

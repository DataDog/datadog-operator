...
// NewInitializedDatadogAgentInternalBuilder returns a builder initialized with a name, namespace, credentials, and metadata.
...
// WithName sets the DatadogAgentInternal name.

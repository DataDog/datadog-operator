...
const (
	...
	GatewayClassesResource     = "gatewayclasses"
	GatewaysResource           = "gateways"
	HTTPRoutesResource         = "httproutes"
	GRPCRoutesResource         = "grpcroutes"
	BackendTLSPoliciesResource = "backendtlspolicies"
	ListenerSetsResource       = "listenersets"
	ReferenceGrantsResource    = "referencegrants"
	TCPRoutesResource          = "tcproutes"
	TLSRoutesResource          = "tlsroutes"
	UDPRoutesResource          = "udproutes"

	// Gateway API Inference Extension resources
	InferencePoolsResource       = "inferencepools"
	InferencePoolImportsResource = "inferencepoolimports"

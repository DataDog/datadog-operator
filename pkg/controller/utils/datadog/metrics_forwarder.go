...
func getbaseURL(dda *datadoghqv1alpha1.DatadogAgent) string {
	if datadoghqv1alpha1.BoolValue(dda.Spec.Agent.Enabled) && dda.Spec.Agent.NodeAgent != nil && dda.Spec.Agent.NodeAgent.DDUrl != nil {
		return *dda.Spec.Agent.NodeAgent.DDUrl

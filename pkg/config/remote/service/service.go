...
import (
	...
	"github.com/DataDog/datadog-operator/pkg/config/remote/api"
	rdata "github.com/DataDog/datadog-operator/pkg/config/remote/data"
...
func NewService() (*Service, error) {
	...
	apiKey := creds.APIKey
	authKeys, err := getRemoteConfigAuthKeys(apiKey, "")
	if err != nil {
		return nil, err
	}
	...
	dbPath := path.Join("/tmp/remote-config.db")

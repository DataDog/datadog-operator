...
`
	...
	cmd.Flags().StringVarP(&o.destPath, "destPath", "d", "destination.yaml", "Path to destination YAML file.")
...
func (o *Options) Init(cmd *cobra.Command) error {
	o.mappingPath, _ = resolveFilePath(o.mappingPath)
	o.sourcePath, _ = resolveFilePath(o.sourcePath)
	o.destPath, _ = resolveFilePath(o.destPath)

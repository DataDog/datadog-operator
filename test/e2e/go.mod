...
require (
	github.com/DataDog/datadog-agent/test/e2e-framework v0.0.0-20260827152032-20b70a0059ad
	github.com/DataDog/datadog-agent/test/fakeintake v0.84.0-devel.0.20260825182512-689caf9a350d
...
require (
	...
	github.com/pulumi/pulumi-aws/sdk/v7 v7.37.0 // indirect
	github.com/pulumi/pulumi-awsx/sdk/v3 v3.7.0 // indirect

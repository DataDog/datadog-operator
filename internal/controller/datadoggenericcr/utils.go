...
func (h *MockHandler) createResourcefunc(r *Reconciler, logger logr.Logger, instance *v1alpha1.DatadogGenericCR, status *v1alpha1.DatadogGenericCRStatus, now metav1.Time, hash string) error {
	status.Id = "mock-id"
	status.Created = &now
...
func (h *MockHandler) getResourcefunc(r *Reconciler, instance *v1alpha1.DatadogGenericCR) error {
	return nil
}
func (h *MockHandler) updateResourcefunc(r *Reconciler, instance *v1alpha1.DatadogGenericCR) error {
	return nil
}
func (h *MockHandler) deleteResourcefunc(r *Reconciler, instance *v1alpha1.DatadogGenericCR) error {
	return nil
}

...
func (f *prometheusScrapeFeature) Configure(ddai *v1alpha1.DatadogAgentInternal) (reqComp feature.RequiredComponents) {
	if ddai.Spec.Features == nil {
		return
	}

	prometheusScrape := ddai.Spec.Features.PrometheusScrape

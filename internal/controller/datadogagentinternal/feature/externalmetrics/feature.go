...
func (f *externalMetricsFeature) Configure(ddai *v1alpha1.DatadogAgentInternal) (reqComp feature.RequiredComponents) {
	f.owner = ddai
	em := ddai.Spec.Features.ExternalMetricsServer

...
func defaultGlobalConfig(ddaiSpec *v2alpha1.DatadogAgentSpec) {
	...
	if ddaiSpec.Global.Registry == nil {
		...
		case defaultEuropeSite:
			ddaiSpec.Global.Registry = apiutils.NewStringPointer(images.DefaultEuropeImageRegistry)
		case defaultAsiaSite:
			ddaiSpec.Global.Registry = apiutils.NewStringPointer(images.DefaultAsiaImageRegistry)
		case defaultAzureSite:
			ddaiSpec.Global.Registry = apiutils.NewStringPointer(images.DefaultAzureImageRegistry)
		case defaultGovSite:
			ddaiSpec.Global.Registry = apiutils.NewStringPointer(images.DefaultGovImageRegistry)
		default:
			ddaiSpec.Global.Registry = apiutils.NewStringPointer(images.DefaultImageRegistry)
		}
	}
	...
	apiutils.DefaultBooleanIfUnset(&ddaiSpec.Global.UseFIPSAgent, defaultUseFIPSAgent)

	if ddaiSpec.Global.FIPS == nil {
		ddaiSpec.Global.FIPS = &v2alpha1.FIPSConfig{}
	}
	apiutils.DefaultBooleanIfUnset(&ddaiSpec.Global.FIPS.Enabled, defaultFIPSProxyEnabled)

...
func ApplyAutopilotOverrides(dda metav1.Object, manager feature.PodTemplateManagers) {
...
// IsAutopilotProvider checks if the provider is gke-autopilot
func IsAutopilotProvider(provider string) bool {
	return provider == "gke-autopilot"
}

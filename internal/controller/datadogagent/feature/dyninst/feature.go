...
func (f *dynInstFeature) Configure(dda metav1.Object, ddaSpec *v2alpha1.DatadogAgentSpec, ddaRCStatus *v2alpha1.RemoteConfigConfiguration) (reqComp feature.RequiredComponents) {
...
func mergeConfigs(ddaSpec *v2alpha1.DatadogAgentSpec, ddaRCStatus *v2alpha1.RemoteConfigConfiguration) {
	if ddaRCStatus == nil || ddaRCStatus.Features == nil || ddaRCStatus.Features.DynamicInstrumentation == nil || ddaRCStatus.Features.DynamicInstrumentation.Enabled == nil {
		return
	}
	...
	ddaSpec.Features.DynamicInstrumentation.Enabled = ddaRCStatus.Features.DynamicInstrumentation.Enabled
}

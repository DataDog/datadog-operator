...
//
// The OpenShift SELinux type is NOT here: it is required by the node agent generally,
// not just for reading pod logs. See NodeAgentProviderSpec in the global package.

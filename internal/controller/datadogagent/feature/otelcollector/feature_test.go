...
var defaultAnnotations = map[string]string{"checksum/otel_agent-custom-config": "ae1d172378fb4bf7a4a3b3e712bc6bb6"}
	...
	tests := test.FeatureTestSuite{
		...
		},
		{
			...
			Agent: testExpectedAgent(apicommon.OtelAgent, expectedPorts{
				...
				map[string]string{"checksum/otel_agent-custom-config": "dbc8ba28798d79e64a86f4268242ea4f"},
				defaultVolumeMounts,
		...
		// gateway enabled
		{
			...
			Agent: testExpectedAgent(apicommon.OtelAgent, defaultExpectedPorts,
				defaultExpectedEnvVars,
				map[string]string{"checksum/otel_agent-custom-config": "5118efc9b104b179fd63ed45f89aac40"},
				defaultVolumeMounts,
				defaultVolumes(defaultLocalObjectReferenceName),
			),
		},
		{
			...
			Agent: testExpectedAgent(apicommon.OtelAgent, expectedPorts{
				...
				defaultExpectedEnvVars,
				map[string]string{"checksum/otel_agent-custom-config": "8d9daae6cc15082c77a49b524bb1e406"},
				defaultVolumeMounts,
				defaultVolumes(defaultLocalObjectReferenceName),
			),
		},

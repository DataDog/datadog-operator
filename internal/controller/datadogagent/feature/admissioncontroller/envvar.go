...
const (
	...
	DDAdmissionControllerAgentSidecarClusterAgentTLSVerificationEnabled         = "DD_ADMISSION_CONTROLLER_AGENT_SIDECAR_CLUSTER_AGENT_TLS_VERIFICATION_ENABLED"
	DDAdmissionControllerAgentSidecarClusterAgentTLSVerificationCopyCaConfigMap = "DD_ADMISSION_CONTROLLER_AGENT_SIDECAR_CLUSTER_AGENT_TLS_VERIFICATION_COPY_CA_CONFIGMAP"

...
func TestEmitExperimentTransitionEvent_AllTransitions(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			oldStatus:  &v2alpha1.ExperimentStatus{Phase: v2alpha1.ExperimentPhaseRunning, ID: "exp-1"},
			newStatus:  &v2alpha1.ExperimentStatus{Phase: v2alpha1.ExperimentPhaseAborted, ID: "exp-1", TerminationReason: v2alpha1.ExperimentTerminationReasonManualSpecChange},
			wantReason: eventReasonExperimentAborted,
			wantType:   "Warning",
			wantInMsg:  "manual spec change",
		},
		{
			name:       "Running to Aborted/baseline_missing",
			oldStatus:  &v2alpha1.ExperimentStatus{Phase: v2alpha1.ExperimentPhaseRunning, ID: "exp-1"},
			newStatus:  &v2alpha1.ExperimentStatus{Phase: v2alpha1.ExperimentPhaseAborted, ID: "exp-1", TerminationReason: v2alpha1.ExperimentTerminationReasonBaselineMissing},
			wantReason: eventReasonExperimentAborted,
			wantType:   "Warning",
			wantInMsg:  "baseline missing",
		},
		{
			name:       "Running to Aborted/baseline_not_found",
			oldStatus:  &v2alpha1.ExperimentStatus{Phase: v2alpha1.ExperimentPhaseRunning, ID: "exp-1"},
			newStatus:  &v2alpha1.ExperimentStatus{Phase: v2alpha1.ExperimentPhaseAborted, ID: "exp-1", TerminationReason: v2alpha1.ExperimentTerminationReasonBaselineNotFound},
			wantReason: eventReasonExperimentAborted,
			wantType:   "Warning",
			wantInMsg:  "baseline not found",
		},
		{
			name:       "nil to Aborted/baseline_missing (immediate start abort)",
			oldStatus:  nil,
			newStatus:  &v2alpha1.ExperimentStatus{Phase: v2alpha1.ExperimentPhaseAborted, ID: "exp-1", TerminationReason: v2alpha1.ExperimentTerminationReasonBaselineMissing},
			wantReason: eventReasonExperimentAborted,
			wantType:   "Warning",
		...
		},
		{
			...
			oldStatus:  &v2alpha1.ExperimentStatus{Phase: v2alpha1.ExperimentPhaseRunning, ID: "exp-1"},
			newStatus:  &v2alpha1.ExperimentStatus{Phase: v2alpha1.ExperimentPhaseTerminated, ID: "exp-1", TerminationReason: v2alpha1.ExperimentTerminationReasonTimedOut},
		...
		},
		{
			...
			oldStatus:  &v2alpha1.ExperimentStatus{Phase: v2alpha1.ExperimentPhaseRunning, ID: "exp-1"},
			newStatus:  &v2alpha1.ExperimentStatus{Phase: v2alpha1.ExperimentPhaseTerminated, ID: "exp-1", TerminationReason: v2alpha1.ExperimentTerminationReasonStopped},
		...
		},
		{
			...
			oldStatus:  &v2alpha1.ExperimentStatus{Phase: v2alpha1.ExperimentPhaseTerminated, ID: "exp-old", TerminationReason: v2alpha1.ExperimentTerminationReasonTimedOut},
			newStatus:  &v2alpha1.ExperimentStatus{Phase: v2alpha1.ExperimentPhaseRunning, ID: "exp-new", StartTaskID: "task-N"},
			wantReason: eventReasonExperimentStartProcessed,
			wantType:   "Normal",
			wantInMsg:  "exp-new",
